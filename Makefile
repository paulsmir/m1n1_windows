...
OBJECTS := \
	...
	gxf.o gxf_asm.o \
	heapblock.o \
	hv.o hv_vm.o hv_exc.o hv_vuart.o hv_pl011.o hv_pci.o hv_nvme.o hv_nvme_queue.o hv_fb_stream.o hv_wdt.o hv_asm.o hv_aic.o hv_virtio.o hv_psci.o hv_vgic.o \
	i2c.o \
	iodev.o \
	iova.o \
	isp.o \
